...
public class DroneRunnerModel extends EntityModel<DroneRunner> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        AVPResources.location("drone_runner"),
        "main"
    );
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition root = partdefinition.addOrReplaceChild(
            ...
            PartPose.offset(-0.25F, 3.2F, 0.0F)
        );
        ...
        PartDefinition gNeck = gUpperBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(23, 86)
                .addBox(-2.0F, -3.0F, -4.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.25F))
                .texOffs(23, 86)
                .addBox(-2.0F, -3.0F, -9.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 1.9594F, -7.8148F, -0.7854F, 0.0F, 0.0F)
        );
        ...
        PartDefinition gMouth = gHead.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(52, 20)
                .addBox(-1.5F, -1.0F, -2.5F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 6.8894F, 0.1508F, 0.829F, 0.0F, 0.0F)
        );
        ...
        PartDefinition gLeftArm = gUpperBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .mirror(false),
            PartPose.offsetAndRotation(4.5F, 3.2139F, -6.4516F, 0.3927F, 0.0F, 0.0F)
        );
        ...
        PartDefinition leftarm5_r1 = gLeftHand.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(60, 38)
                .mirror()
                .addBox(2.8F, 0.0F, -3.0F, 3.0F, 0.0F, 6.0F, new CubeDeformation(0.0F))
                .mirror(false),
            PartPose.offsetAndRotation(-4.75F, 0.0F, -3.05F, 0.1309F, 0.0F, 0.0F)
        );
        ...
        PartDefinition gRightArm = gUpperBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(50, 29)
                .addBox(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.0F, 3.2139F, -6.4516F, 0.3927F, 0.0F, 0.0F)
        );
        ...
        PartDefinition rightarm6_r1 = gRightHand.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(60, 38)
                .addBox(-5.8F, 0.0F, -3.0F, 3.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(4.75F, 0.0F, -3.05F, 0.1309F, 0.0F, 0.0F)
        );

        PartDefinition gDorsalSpines = gUpperBody.addOrReplaceChild(
            "gDorsalSpines",
            CubeListBuilder.create(),
            PartPose.offset(0.0F, -2.3007F, -4.9748F)
        );

        PartDefinition body3_r1 = gDorsalSpines.addOrReplaceChild(
            "body3_r1",
            CubeListBuilder.create()
                .texOffs(9, 86)
                .mirror()
                .addBox(0.0F, -4.6F, 2.6F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
                .mirror(false),
            PartPose.offsetAndRotation(-4.0F, -2.9854F, -4.2268F, -0.7745F, -0.1836F, -0.1186F)
        );

        PartDefinition body4_r1 = gDorsalSpines.addOrReplaceChild(
            "body4_r1",
            CubeListBuilder.create()
                .texOffs(9, 86)
                .mirror()
                .addBox(-2.7523F, -4.5957F, -0.8679F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
                .mirror(false),
            PartPose.offsetAndRotation(-0.5F, 1.037F, 0.8983F, -0.9958F, -0.2048F, -0.0757F)
        );

        PartDefinition body5_r1 = gDorsalSpines.addOrReplaceChild(
            "body5_r1",
            CubeListBuilder.create()
                .texOffs(9, 86)
                .addBox(0.7523F, -4.5957F, -0.8679F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.5F, 1.037F, 0.8983F, -0.9958F, 0.2048F, 0.0757F)
        );

        PartDefinition body4_r2 = gDorsalSpines.addOrReplaceChild(
            "body4_r2",
            CubeListBuilder.create()
                .texOffs(9, 86)
                .addBox(-2.0F, -4.6F, 2.6F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(4.0F, -2.9854F, -4.2268F, -0.7745F, 0.1836F, 0.1186F)
        );
        ...
        PartDefinition gRightLeg = gLowerBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .mirror(false),
            PartPose.offsetAndRotation(-4.0F, 3.4328F, 8.544F, -0.3927F, 0.0F, 0.0F)
        );
        ...
        PartDefinition gLeftLeg = gLowerBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(40, 45)
                .addBox(-2.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(4.5F, 3.4328F, 8.544F, -0.3927F, 0.0F, 0.0F)
        );
        ...
        PartDefinition gTail1 = gLowerBody.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(0.0F, 2.6828F, 11.244F, -0.3927F, 0.0F, 0.0F)
        );
        ...
        PartDefinition gTail2 = gTail1.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(0.0F, 0.0F, 9.35F, -0.3927F, 0.0F, 0.0F)
        );
