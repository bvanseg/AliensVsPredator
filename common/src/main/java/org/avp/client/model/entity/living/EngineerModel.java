    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition gChest = root.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .texOffs(12, 29)
                .addBox(-3.0F, -1.0F, 2.5F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.3F)),
        ...
        PartDefinition gLeftArm = gChest.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(44, 22)
                .addBox(1.1F, -0.25F, -1.2F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.35F)),
            PartPose.offset(3.1F, 0.05F, -0.2F)
        );

        PartDefinition rArmUpper_r1 = gLeftArm.addOrReplaceChild(
            "rArmUpper_r1",
            CubeListBuilder.create()
                .texOffs(56, 24)
                .addBox(0.7F, -2.8F, -0.8F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.45F)),
            PartPose.offsetAndRotation(2.0F, 2.25F, 0.0F, 0.0F, 0.0F, -1.309F)
        );
        ...
        PartDefinition gLeftForearm = gLeftArm.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(2.0F, 6.15F, 0.0F, 0.0F, 0.0F, 0.0F)
        );
        ...
        PartDefinition lArmLower_3_r1 = gLeftHand.addOrReplaceChild(
            "lArmLower_3_r1",
            CubeListBuilder.create()
                .texOffs(44, 38)
        ...
        PartDefinition gRightArm = gChest.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(44, 22)
                .mirror()
                .addBox(-3.1F, -0.25F, -1.2F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.35F))
                .mirror(false),
            PartPose.offset(-3.1F, 0.05F, -0.2F)
        );

        PartDefinition rArmUpper_r2 = gRightArm.addOrReplaceChild(
            "rArmUpper_r2",
            CubeListBuilder.create()
                .texOffs(56, 24)
                .mirror()
                .addBox(-2.7F, -2.8F, -0.8F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.45F))
                .mirror(false),
            PartPose.offsetAndRotation(-2.0F, 2.25F, 0.0F, 0.0F, 0.0F, 1.309F)
        );
