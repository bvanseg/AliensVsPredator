...
public class PraetorianModel extends GeoModel<Praetorian> {

    private static final String ENTITY_NAME = "praetorian";
    ...
    @Override
    public ResourceLocation getModelResource(Praetorian entity) {
        return MODEL_LOCATION;
    }

    @Override
    public ResourceLocation getTextureResource(Praetorian entity) {
        return TEXTURE_LOCATION;
    }

    @Override
    public ResourceLocation getAnimationResource(Praetorian entity) {
