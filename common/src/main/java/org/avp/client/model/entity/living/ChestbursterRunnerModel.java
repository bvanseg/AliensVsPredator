...
public class ChestbursterRunnerModel extends EntityModel<ChestbursterRunner> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AVPResources.location("chestburster_runner"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition gTail2 = gTail1.addOrReplaceChild("gTail2", CubeListBuilder.create().texOffs(87, 91).addBox(0.0F, -4.5F, -0.3F, 0.0F, 8.0F, 13.0F, new CubeDeformation(0.0F))
		...
		.texOffs(116, 93).addBox(0.0F, -2.9F, 0.3F, 0.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.25F, 10.4F));
		...
		.texOffs(147, 95).addBox(0.0F, -2.1F, 0.1F, 0.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.25F, 11.0F));
		...
		.texOffs(178, 66).addBox(-0.5F, -0.2F, 0.0F, 1.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.25F, 11.0F));

		PartDefinition gTailClaw = gTail5.addOrReplaceChild("gTailClaw", CubeListBuilder.create(), PartPose.offset(0.0F, 0.3F, 10.7F));

		PartDefinition tailStabber_r1 = gTailClaw.addOrReplaceChild("tailStabber_r1", CubeListBuilder.create().texOffs(211, 56).mirror().addBox(0.0F, -11.5F, 13.15F, 0.0F, 13.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -17.6469F, -1.5531F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition gNeck = gChest.addOrReplaceChild("gNeck", CubeListBuilder.create().texOffs(23, 86).addBox(-2.5F, -3.0F, -5.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.65F, -7.95F, -0.3927F, 0.0F, 0.0F));

		PartDefinition gHead = gNeck.addOrReplaceChild("gHead", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -5.0478F, -4.6654F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.138F, -4.4629F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition headTop_r1 = gHead.addOrReplaceChild("headTop_r1", CubeListBuilder.create().texOffs(28, 10).addBox(-2.5F, -36.4F, -9.3F, 5.0F, 10.0F, 5.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 23.0005F, -4.2319F, -0.3187F, 0.0F, 0.0F));
		...
		PartDefinition jawLower = bone.addOrReplaceChild("jawLower", CubeListBuilder.create().texOffs(88, 1).addBox(-1.5F, -0.1F, -4.4F, 3.0F, 1.0F, 5.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, 11.0971F, -8.9638F));
	...
	@Override
	public void setupAnim(ChestbursterRunner entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {}
