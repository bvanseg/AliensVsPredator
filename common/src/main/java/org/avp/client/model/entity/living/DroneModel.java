...
public class DroneModel extends EntityModel<Drone> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition backhorn2_r1 = gUpperBody.addOrReplaceChild("backhorn2_r1", CubeListBuilder.create().texOffs(10, 86).mirror().addBox(0.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.5F, -4.7861F, -7.2016F, 0.0F, 0.0F, 0.3927F));

		PartDefinition backhorn3_r1 = gUpperBody.addOrReplaceChild("backhorn3_r1", CubeListBuilder.create().texOffs(10, 86).mirror().addBox(0.0F, -5.5F, 3.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.5F, -4.7861F, -7.2016F, -0.3927F, 0.0F, 0.3927F));
		...
		PartDefinition backhorn1_r1 = gUpperBody.addOrReplaceChild("backhorn1_r1", CubeListBuilder.create().texOffs(10, 86).addBox(-2.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -4.7861F, -7.2016F, 0.0F, 0.0F, -0.3927F));

		PartDefinition gNeck = gUpperBody.addOrReplaceChild("gNeck", CubeListBuilder.create().texOffs(23, 86).addBox(-2.0F, -3.0F, -5.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.8094F, -8.6648F, 0.0F, 0.0F, 0.0F));
		...
		PartDefinition gRightArm = gUpperBody.addOrReplaceChild("gRightArm", CubeListBuilder.create().texOffs(50, 29).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, 3.2139F, -7.2016F, 0.3927F, 0.0F, 0.3927F));

		PartDefinition gRightForearm = gRightArm.addOrReplaceChild("gRightForearm", CubeListBuilder.create().texOffs(98, 9).addBox(-1.0F, -1.0F, -10.5F, 2.0F, 2.0F, 11.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, 11.5F, 0.0F));
		...
		PartDefinition gLeftArm = gUpperBody.addOrReplaceChild("gLeftArm", CubeListBuilder.create().texOffs(50, 29).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.5F, 3.2139F, -7.2016F, 0.3927F, 0.0F, -0.3927F));

		PartDefinition gLeftForearm = gLeftArm.addOrReplaceChild("gLeftForearm", CubeListBuilder.create().texOffs(98, 9).mirror().addBox(-1.0F, -1.0F, -10.5F, 2.0F, 2.0F, 11.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offset(0.0F, 11.5F, 0.0F));
		...
		PartDefinition gLowerBody = gBody.addOrReplaceChild("gLowerBody", CubeListBuilder.create().texOffs(23, 65).addBox(0.0F, -5.9328F, 0.756F, 0.0F, 6.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(0, 27).addBox(-3.5F, -0.0672F, 0.044F, 7.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, -0.25F, -0.3491F, 0.0F, 0.0F));

		PartDefinition gRightLeg = gLowerBody.addOrReplaceChild("gRightLeg", CubeListBuilder.create().texOffs(40, 45).mirror().addBox(-2.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.4328F, 8.544F, -0.3927F, 0.0F, 0.3927F));
		...
		PartDefinition gRightFoot = gRightLowerLeg.addOrReplaceChild("gRightFoot", CubeListBuilder.create().texOffs(110, 24).mirror().addBox(-1.0F, 0.0F, -4.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.7389F, 0.3165F, -0.2363F));

		PartDefinition gLeftLeg = gLowerBody.addOrReplaceChild("gLeftLeg", CubeListBuilder.create().texOffs(40, 45).addBox(-2.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 3.4328F, 8.544F, -0.3927F, 0.0F, -0.3927F));
		...
		PartDefinition gLeftFoot = gLeftLowerLeg.addOrReplaceChild("gLeftFoot", CubeListBuilder.create().texOffs(110, 24).addBox(-1.0F, 0.0F, -4.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.7389F, -0.3165F, 0.2363F));

		PartDefinition gTail1 = gLowerBody.addOrReplaceChild("gTail1", CubeListBuilder.create().texOffs(57, 94).addBox(0.0F, -4.8F, 0.3F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(50, 66).addBox(-2.0F, -2.5F, -0.3F, 4.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.9328F, 11.744F));

		PartDefinition gTail2 = gTail1.addOrReplaceChild("gTail2", CubeListBuilder.create().texOffs(90, 95).addBox(0.0F, -3.8F, 0.65F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(85, 66).addBox(-2.0F, -2.5F, 0.1F, 4.0F, 4.0F, 11.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 10.35F, 0.0F, -0.3927F, 0.0F));

		PartDefinition gTail3 = gTail2.addOrReplaceChild("gTail3", CubeListBuilder.create().texOffs(118, 66).addBox(-1.5F, -1.5F, -0.5F, 3.0F, 3.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(116, 92).addBox(0.0F, -3.8F, 0.0F, 0.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0132F, -0.5F, 11.1184F, 0.0F, -0.3927F, 0.0F));
		...
		PartDefinition gTail4 = gTail3.addOrReplaceChild("gTail4", CubeListBuilder.create().texOffs(149, 66).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(147, 95).addBox(0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 10.5F, 0.0F, -0.3927F, 0.0F));

		PartDefinition gTail5 = gTail4.addOrReplaceChild("gTail5", CubeListBuilder.create().texOffs(177, 66).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(176, 96).addBox(0.0F, -1.4F, 0.0F, 0.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 11.0F, 0.0F, -0.3927F, 0.0F));
