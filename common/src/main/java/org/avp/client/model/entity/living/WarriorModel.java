...
public class WarriorModel extends EntityModel<Warrior> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition root = partdefinition.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(0.0F, -1.7F, 0.0F, -0.3142F, 0.0F, 0.0F)
        );
        ...
        PartDefinition backhorn2_r1 = gUpperBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(9, 86)
                .mirror()
                .addBox(0.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.1F))
                .mirror(false),
        ...
        PartDefinition backhorn1_r1 = gUpperBody.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(9, 86)
                .addBox(-2.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.1F)),
            PartPose.offsetAndRotation(-2.5F, -4.7861F, -7.2016F, 0.0F, 0.0F, -0.3927F)
        );
        ...
        PartDefinition head6_r1 = gHead.addOrReplaceChild(
            "head6_r1",
            CubeListBuilder.create()
                .texOffs(6, 98)
                .addBox(-0.5F, -13.2562F, -3.4087F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.5F, -3.5601F, -4.0133F, -0.3054F, 0.0F, 0.0F)
        );

        PartDefinition head2_r1 = gHead.addOrReplaceChild(
            "head2_r1",
            CubeListBuilder.create()
                .texOffs(1, 98)
                .addBox(0.0F, -5.0F, -2.5F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, -2.5027F, -7.115F, -3.1329F, 0.0F, 3.1416F)
        );
        ...
        PartDefinition head4_r1 = gHead.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(52, 20)
                .addBox(-1.5F, 4.8963F, -7.7195F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition rightarm4_r1 = gRightHand.addOrReplaceChild(
            "rightarm4_r1",
            CubeListBuilder.create()
                .texOffs(60, 38)
