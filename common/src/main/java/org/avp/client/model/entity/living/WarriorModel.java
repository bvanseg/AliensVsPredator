...
public class WarriorModel extends EntityModel<Warrior> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition gTail2 = gTail1.addOrReplaceChild("gTail2", CubeListBuilder.create().texOffs(90, 95).addBox(0.0F, -3.8F, 0.65F, 0.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 9.85F, 0.0F, -0.3927F, 0.0F));
		...
		PartDefinition gTail3 = gTail2.addOrReplaceChild("gTail3", CubeListBuilder.create().texOffs(116, 92).addBox(0.0F, -3.8F, 0.0F, 0.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0132F, -0.5F, 10.6184F, 0.0F, -0.3927F, 0.0F));
		...
		PartDefinition gTail4 = gTail3.addOrReplaceChild("gTail4", CubeListBuilder.create().texOffs(147, 95).addBox(0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 10.0F, 0.0F, -0.3927F, 0.0F));
		...
		PartDefinition gTail5 = gTail4.addOrReplaceChild("gTail5", CubeListBuilder.create().texOffs(176, 96).addBox(0.0F, -1.4F, 0.0F, 0.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 10.5F, 0.0F, -0.3927F, 0.0F));
