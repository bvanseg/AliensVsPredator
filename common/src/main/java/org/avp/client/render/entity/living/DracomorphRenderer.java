...
public class DracomorphRenderer extends GeoEntityRenderer<Dracomorph> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Dracomorph animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
