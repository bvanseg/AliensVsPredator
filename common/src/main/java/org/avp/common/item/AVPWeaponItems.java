...
public class AVPWeaponItems implements AVPRegistry {
    ...
    public void register() {
        ...
        Services.ITEM_REGISTRY.register("ammo_charge_pack", () -> new Item(new Item.Properties()));
        ...
        Services.ITEM_REGISTRY.register("grenade_incendiary", () -> new Item(new Item.Properties()));
        Services.ITEM_REGISTRY.register("grenade_m40", () -> new Item(new Item.Properties()));
