...
public class AVPEngineerBlocks {
    ...
    static {
        ...
        ENGINEER_SHIP_BRICK_SLAB = AVPBlocks.register("engineer_ship_brick_slab", BlockDataUtils.slab(ENGINEER_SHIP_BRICK, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_STAIRS = AVPBlocks.register("engineer_ship_brick_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_BRICK, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_WALL = AVPBlocks.register("engineer_ship_brick_wall", BlockDataUtils.wall(ENGINEER_SHIP_BRICK, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_BRICK_1 = AVPBlocks.register("engineer_ship_brick_1", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_1_SLAB = AVPBlocks.register("engineer_ship_brick_1_slab", BlockDataUtils.slab(ENGINEER_SHIP_BRICK_1, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_1_STAIRS = AVPBlocks.register("engineer_ship_brick_1_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_BRICK_1, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_1_WALL = AVPBlocks.register("engineer_ship_brick_1_wall", BlockDataUtils.wall(ENGINEER_SHIP_BRICK_1, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_BRICK_2 = AVPBlocks.register("engineer_ship_brick_2", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_2_SLAB = AVPBlocks.register("engineer_ship_brick_2_slab", BlockDataUtils.slab(ENGINEER_SHIP_BRICK_2, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_2_STAIRS = AVPBlocks.register("engineer_ship_brick_2_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_BRICK_2, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_2_WALL = AVPBlocks.register("engineer_ship_brick_2_wall", BlockDataUtils.wall(ENGINEER_SHIP_BRICK_2, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_BRICK_3 = AVPBlocks.register("engineer_ship_brick_3", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_3_SLAB = AVPBlocks.register("engineer_ship_brick_3_slab", BlockDataUtils.slab(ENGINEER_SHIP_BRICK_3, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_3_STAIRS = AVPBlocks.register("engineer_ship_brick_3_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_BRICK_3, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_BRICK_3_WALL = AVPBlocks.register("engineer_ship_brick_3_wall", BlockDataUtils.wall(ENGINEER_SHIP_BRICK_3, ENGINEER_SHIP_PROPERTIES));
        ...
        ENGINEER_SHIP_MATERIAL_0_SLAB = AVPBlocks.register("engineer_ship_material_0_slab", BlockDataUtils.slab(ENGINEER_SHIP_MATERIAL_0, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_0_STAIRS = AVPBlocks.register("engineer_ship_material_0_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_MATERIAL_0, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_0_WALL = AVPBlocks.register("engineer_ship_material_0_wall", BlockDataUtils.wall(ENGINEER_SHIP_MATERIAL_0, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_MATERIAL_1 = AVPBlocks.register("engineer_ship_material_1", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_1_SLAB = AVPBlocks.register("engineer_ship_material_1_slab", BlockDataUtils.slab(ENGINEER_SHIP_MATERIAL_1, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_1_STAIRS = AVPBlocks.register("engineer_ship_material_1_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_MATERIAL_1, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_1_WALL = AVPBlocks.register("engineer_ship_material_1_wall", BlockDataUtils.wall(ENGINEER_SHIP_MATERIAL_1, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_MATERIAL_2 = AVPBlocks.register("engineer_ship_material_2", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_2_SLAB = AVPBlocks.register("engineer_ship_material_2_slab", BlockDataUtils.slab(ENGINEER_SHIP_MATERIAL_2, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_2_STAIRS = AVPBlocks.register("engineer_ship_material_2_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_MATERIAL_2, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_MATERIAL_2_WALL = AVPBlocks.register("engineer_ship_material_2_wall", BlockDataUtils.wall(ENGINEER_SHIP_MATERIAL_2, ENGINEER_SHIP_PROPERTIES));
        ...
        ENGINEER_SHIP_WALL_SLAB = AVPBlocks.register("engineer_ship_wall_slab", BlockDataUtils.slab(ENGINEER_SHIP_WALL, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_STAIRS = AVPBlocks.register("engineer_ship_wall_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_WALL, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_WALL = AVPBlocks.register("engineer_ship_wall_wall", BlockDataUtils.wall(ENGINEER_SHIP_WALL, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_WALL_1 = AVPBlocks.register("engineer_ship_wall_1", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_1_SLAB = AVPBlocks.register("engineer_ship_wall_1_slab", BlockDataUtils.slab(ENGINEER_SHIP_WALL_1, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_1_STAIRS = AVPBlocks.register("engineer_ship_wall_1_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_WALL_1, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_1_WALL = AVPBlocks.register("engineer_ship_wall_1_wall", BlockDataUtils.wall(ENGINEER_SHIP_WALL_1, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_WALL_2 = AVPBlocks.register("engineer_ship_wall_2", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_2_SLAB = AVPBlocks.register("engineer_ship_wall_2_slab", BlockDataUtils.slab(ENGINEER_SHIP_WALL_2, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_2_STAIRS = AVPBlocks.register("engineer_ship_wall_2_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_WALL_2, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_2_WALL = AVPBlocks.register("engineer_ship_wall_2_wall", BlockDataUtils.wall(ENGINEER_SHIP_WALL_2, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_WALL_3 = AVPBlocks.register("engineer_ship_wall_3", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_3_SLAB = AVPBlocks.register("engineer_ship_wall_3_slab", BlockDataUtils.slab(ENGINEER_SHIP_WALL_3, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_3_STAIRS = AVPBlocks.register("engineer_ship_wall_3_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_WALL_3, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_3_WALL = AVPBlocks.register("engineer_ship_wall_3_wall", BlockDataUtils.wall(ENGINEER_SHIP_WALL_3, ENGINEER_SHIP_PROPERTIES));

        ENGINEER_SHIP_WALL_4 = AVPBlocks.register("engineer_ship_wall_4", BlockData.simple(ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_4_SLAB = AVPBlocks.register("engineer_ship_wall_4_slab", BlockDataUtils.slab(ENGINEER_SHIP_WALL_4, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_4_STAIRS = AVPBlocks.register("engineer_ship_wall_4_stairs", BlockDataUtils.stairs(ENGINEER_SHIP_WALL_4, ENGINEER_SHIP_PROPERTIES));
        ENGINEER_SHIP_WALL_4_WALL = AVPBlocks.register("engineer_ship_wall_4_wall", BlockDataUtils.wall(ENGINEER_SHIP_WALL_4, ENGINEER_SHIP_PROPERTIES));
    }
