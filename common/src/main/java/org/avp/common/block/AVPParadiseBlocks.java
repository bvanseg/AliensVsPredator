...
public class AVPParadiseBlocks {
    ...
    static {
        ...
        PARADISE_DIRT_PODZOL = AVPBlocks.register("paradise_dirt_podzol", BlockDataUtils.grass(PARADISE_DIRT, BlockBehaviour.Properties.ofFullCopy(Blocks.PODZOL)));
        PARADISE_GRASS = AVPBlocks.register("paradise_grass", BlockDataUtils.grass(PARADISE_DIRT, BlockBehaviour.Properties.ofFullCopy(Blocks.GRASS_BLOCK)));
