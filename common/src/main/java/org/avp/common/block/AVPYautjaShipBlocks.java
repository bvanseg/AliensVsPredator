...
public class AVPYautjaShipBlocks {
    ...
    static {
        ...
        YAUTJA_SHIP_BRICK_SLAB = AVPBlocks.register(
            "yautja_ship_brick_slab",
            BlockDataUtils.slab(YAUTJA_SHIP_BRICK, YAUTJA_SHIP_PROPERTIES)
        );
        YAUTJA_SHIP_BRICK_STAIRS = AVPBlocks.register(
            "yautja_ship_brick_stairs",
            BlockDataUtils.stairs(YAUTJA_SHIP_BRICK, YAUTJA_SHIP_PROPERTIES)
        );
        YAUTJA_SHIP_BRICK_WALL = AVPBlocks.register(
            "yautja_ship_brick_wall",
            BlockDataUtils.wall(YAUTJA_SHIP_BRICK, YAUTJA_SHIP_PROPERTIES)
        );
        ...
        YAUTJA_SHIP_DECOR_3_SLAB = AVPBlocks.register(
            "yautja_ship_decor_3_slab",
            BlockDataUtils.slab(YAUTJA_SHIP_DECOR_3, YAUTJA_SHIP_PROPERTIES)
        );
        YAUTJA_SHIP_DECOR_3_STAIRS = AVPBlocks.register(
            "yautja_ship_decor_3_stairs",
            BlockDataUtils.stairs(YAUTJA_SHIP_DECOR_3, YAUTJA_SHIP_PROPERTIES)
        );
        YAUTJA_SHIP_DECOR_3_WALL = AVPBlocks.register(
            "yautja_ship_decor_3_wall",
            BlockDataUtils.wall(YAUTJA_SHIP_DECOR_3, YAUTJA_SHIP_PROPERTIES)
        );

        YAUTJA_SHIP_PANEL = AVPBlocks.register("yautja_ship_panel", BlockData.simple(YAUTJA_SHIP_PROPERTIES));
        YAUTJA_SHIP_SUPPORT_PILLAR = AVPBlocks.register(
            "yautja_ship_support_pillar",
            BlockData.simple(YAUTJA_SHIP_PROPERTIES)
        );
