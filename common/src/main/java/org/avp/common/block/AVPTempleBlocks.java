...
public class AVPTempleBlocks {
    ...
    static {
        ...
        TEMPLE_BRICK_SLAB = AVPBlocks.register(
            "temple_brick_slab",
            BlockDataUtils.slab(TEMPLE_BRICK, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_BRICK_STAIRS = AVPBlocks.register(
            "temple_brick_stairs",
            BlockDataUtils.stairs(TEMPLE_BRICK, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_BRICK_WALL = AVPBlocks.register(
            "temple_brick_wall",
            BlockDataUtils.wall(TEMPLE_BRICK, TEMPLE_BRICK_PROPERTIES)
        );

        TEMPLE_BRICK_CHESTBURSTER = AVPBlocks.register(
            "temple_brick_chestburster",
            BlockData.simple(TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_BRICK_FACEHUGGER = AVPBlocks.register(
        ...
        TEMPLE_BRICK_SINGLE_SLAB = AVPBlocks.register(
            "temple_brick_single_slab",
            BlockDataUtils.slab(TEMPLE_BRICK_SINGLE, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_BRICK_SINGLE_STAIRS = AVPBlocks.register(
            "temple_brick_single_stairs",
            BlockDataUtils.stairs(TEMPLE_BRICK_SINGLE, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_BRICK_SINGLE_WALL = AVPBlocks.register(
            "temple_brick_single_wall",
            BlockDataUtils.wall(TEMPLE_BRICK_SINGLE, TEMPLE_BRICK_PROPERTIES)
        );

        TEMPLE_FLOOR = AVPBlocks.register("temple_floor", BlockData.simple(TEMPLE_BRICK_PROPERTIES));
        TEMPLE_FLOOR_SLAB = AVPBlocks.register(
            "temple_floor_slab",
            BlockDataUtils.slab(TEMPLE_FLOOR, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_FLOOR_STAIRS = AVPBlocks.register(
            "temple_floor_stairs",
            BlockDataUtils.stairs(TEMPLE_FLOOR, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_FLOOR_WALL = AVPBlocks.register(
            "temple_floor_wall",
            BlockDataUtils.wall(TEMPLE_FLOOR, TEMPLE_BRICK_PROPERTIES)
        );
        ...
        TEMPLE_TILE_SLAB = AVPBlocks.register(
            "temple_tile_slab",
            BlockDataUtils.slab(TEMPLE_TILE, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_TILE_STAIRS = AVPBlocks.register(
            "temple_tile_stairs",
            BlockDataUtils.stairs(TEMPLE_TILE, TEMPLE_BRICK_PROPERTIES)
        );
        TEMPLE_TILE_WALL = AVPBlocks.register(
            "temple_tile_wall",
            BlockDataUtils.wall(TEMPLE_TILE, TEMPLE_BRICK_PROPERTIES)
        );
