...
import org.prometheus.common.block.BlockUnidentifiedLog;
...
{
    public static final IBlockState TREE_TENDONS = PrometheusVardaBlocks.GIGER_TENDONS.getDefaultState();
    public static final IBlockState TREE_LOGS = PrometheusVardaBlocks.GIGER_LOG.getDefaultState().withProperty(BlockUnidentifiedLog.LOG_AXIS, EnumAxis.Y);
    public static final IBlockState TREE_LEAVES = PrometheusVardaBlocks.GIGER_LEAVES.getDefaultState();
    ...
    {
        return new Block[] { PrometheusVardaBlocks.UNIDIRT, PrometheusVardaBlocks.GIGER_SAPLING};
    }
