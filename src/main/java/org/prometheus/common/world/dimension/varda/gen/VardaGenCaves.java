                ...
                for (int somethingZ = minZ; somethingZ < maxZ; somethingZ++)
                {
                    ...
                    for (int somethingY = maxHeight - 1; somethingY >= minHeight; somethingY--)
                    {
                        ...
                        if ((var59 > -0.7D) && (var63 * var63 + var59 * var59 + var54 * var54 < 1.0D))
                        {
                            ...
                            if (ceilBlock == PrometheusVardaBlocks.UNIDIRT)
                            {
                                atSurface = true;
                            }

                            if ((ceilBlock != PrometheusVardaBlocks.UNISTONE) || (ceilBlock != PrometheusVardaBlocks.UNIDIRT) || (ceilBlock != PrometheusVardaBlocks.UNIDIRT))
                            {
                                if (somethingY < 10)
                                {
                                ...
                                else
                                {
                                    ...
                                    if (atSurface && primer.getBlockState(somethingX, somethingY - 1, somethingZ) == PrometheusVardaBlocks.UNIDIRT)
                                    {
