...
import org.prometheus.common.world.dimension.varda.gen.VardaGenCaves;
                    ...
                    for (int eY = 0; eY < 8; eY++)
                    {
                        ...
                        for (int eX = 0; eX < 4; eX++)
                        {
                            ...
                            for (int eZ = 0; eZ < 4; eZ++)
                            {
                                if ((var49 += var47) > 0.0D)
                                {
                                    primer.setBlockState(cX * 4 + eX, cY * 8 + eY, cZ * 4 + eZ, PrometheusVardaBlocks.UNISTONE.getDefaultState());
                                }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (var13 == -1)
                            {
                                ...
                                {
                                    top = Blocks.AIR;
                                    fill = PrometheusVardaBlocks.UNISTONE;
                                }
