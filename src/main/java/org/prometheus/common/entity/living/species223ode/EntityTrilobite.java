...
import org.prometheus.common.entity.ai.brain.parasitoid.TrilobiteBrain;
...
import org.prometheus.common.entity.living.helper.TrilobiteTentacleHelper;
...
public class EntityTrilobite extends EntityParasitoid implements IAnimated
{
    ...
    {
        return new ItemStack(PrometheusItems.SUMMONER_TRILOBITE);
    }
