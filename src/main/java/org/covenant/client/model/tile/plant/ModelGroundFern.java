package org.covenant.client.model.tile.plant;
...
public class ModelGroundFern extends Model<TileEntityGroundFern>
{
    ...
    public final ModelRenderer fiddlehead01;
    public final ModelRenderer fiddlehead02;
    public final ModelRenderer fiddlehead03;
    ...
    public ModelGroundFern()
    {
        ...
        this.setRotation(lowerLeaf04a, -0.4553564018453205F, 3.141592653589793F, 0.0F);
        ...
        this.setRotation(lowerLeaf06a, -0.22759093446006054F, -0.7853981633974483F, 0.0F);
        ...
        this.setRotation(lowerLeaf07a, -0.22759093446006054F, 2.356194490192345F, 0.0F);
        ...
        this.setRotation(lowerLeaf08a, -0.22759093446006054F, -2.356194490192345F, 0.0F);
        ...
        this.upperLeaf03b.addBox(-2.5F, 0.0F, -6.0F, 5, 0, 6, 0.0F);
        this.setRotation(upperLeaf03b, 0.18203784098300857F, 0.0F, 0.0F);
        this.fiddlehead02 = new ModelRenderer(this, 0, 0);
        this.fiddlehead02.setRotationPoint(0.0F, -1.0F, 0.0F);
        this.fiddlehead02.addBox(0.0F, -9.0F, -1.5F, 0, 9, 4, 0.0F);
        this.setRotation(fiddlehead02, -0.5009094953223726F, 2.0943951023931953F, 0.0F);
        ...
        this.setRotation(lowerLeaf01b, 0.27314402793711257F, 0.0F, 0.0F);
        this.upperLeaf04b = new ModelRenderer(this, 22, 25);
        this.upperLeaf04b.setRotationPoint(0.0F, 0.0F, -10.0F);
        this.upperLeaf04b.addBox(-2.5F, 0.0F, -6.0F, 5, 0, 6, 0.0F);
        ...
        this.upperLeaf01a.addBox(-2.5F, 0.0F, -10.0F, 5, 0, 10, 0.0F);
        this.setRotation(upperLeaf01a, -0.6373942428283291F, 0.0F, 0.0F);
        this.upperLeaf01b = new ModelRenderer(this, 22, 25);
        this.upperLeaf01b.setRotationPoint(0.0F, 0.0F, -10.0F);
        this.upperLeaf01b.addBox(-2.5F, 0.0F, -6.0F, 5, 0, 6, 0.0F);
        ...
        this.upperLeaf03a.addBox(-2.5F, 0.0F, -10.0F, 5, 0, 10, 0.0F);
        this.setRotation(upperLeaf03a, -0.6373942428283291F, -2.0943951023931953F, 0.0F);
        ...
        this.upperLeaf04a.addBox(-2.5F, 0.0F, -10.0F, 5, 0, 10, 0.0F);
        this.setRotation(upperLeaf04a, -0.4553564018453205F, 1.0471975511965976F, 0.0F);
        ...
        this.setRotation(lowerLeaf02a, -0.36425021489121656F, 1.5707963267948966F, 0.0F);
        ...
        this.setRotation(lowerLeaf01a, -0.4553564018453205F, 0.0F, 0.0F);
        ...
        this.fiddlehead01.setRotationPoint(0.0F, -1.0F, 0.0F);
        this.fiddlehead01.addBox(0.0F, -9.0F, -1.5F, 0, 9, 4, 0.0F);
        this.setRotation(fiddlehead01, -0.5009094953223726F, 0.0F, 0.0F);
        this.upperLeaf05a = new ModelRenderer(this, 18, 15);
        this.upperLeaf05a.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperLeaf05a.addBox(-2.5F, 0.0F, -10.0F, 5, 0, 10, 0.0F);
        this.setRotation(upperLeaf05a, -0.4553564018453205F, -1.0471975511965976F, 0.0F);
        this.upperLeaf06b = new ModelRenderer(this, 22, 25);
        this.upperLeaf06b.setRotationPoint(0.0F, 0.0F, -10.0F);
        this.upperLeaf06b.addBox(-2.5F, 0.0F, -6.0F, 5, 0, 6, 0.0F);
        ...
        this.setRotation(lowerLeaf03a, -0.36425021489121656F, -1.5707963267948966F, 0.0F);
        this.fiddlehead03 = new ModelRenderer(this, 0, 0);
        this.fiddlehead03.setRotationPoint(0.0F, -1.0F, 0.0F);
        this.fiddlehead03.addBox(0.0F, -9.0F, -1.5F, 0, 9, 4, 0.0F);
        this.setRotation(fiddlehead03, -0.5009094953223726F, -2.0943951023931953F, 0.0F);
        this.crown02 = new ModelRenderer(this, 31, 6);
        this.crown02.setRotationPoint(0.0F, 23.1F, 0.0F);
        this.crown02.addBox(-1.0F, -1.0F, -1.0F, 2, 1, 2, 0.0F);
        this.setRotation(crown02, 0.0F, 0.7853981633974483F, 0.0F);
        this.upperLeaf02b = new ModelRenderer(this, 22, 25);
        this.upperLeaf02b.setRotationPoint(0.0F, 0.0F, -10.0F);
        this.upperLeaf02b.addBox(-2.5F, 0.0F, -6.0F, 5, 0, 6, 0.0F);
        ...
        this.upperLeaf06a.addBox(-2.5F, 0.0F, -10.0F, 5, 0, 10, 0.0F);
        this.setRotation(upperLeaf06a, -0.4553564018453205F, 3.141592653589793F, 0.0F);
        ...
        this.setRotation(lowerLeaf04b, 0.27314402793711257F, 0.0F, 0.0F);
        this.upperLeaf02a = new ModelRenderer(this, 18, 15);
        this.upperLeaf02a.setRotationPoint(0.0F, -0.8F, 0.0F);
        this.upperLeaf02a.addBox(-2.5F, 0.0F, -10.0F, 5, 0, 10, 0.0F);
        this.setRotation(upperLeaf02a, -0.6373942428283291F, 2.0943951023931953F, 0.0F);
        ...
        this.crown02.addChild(this.fiddlehead02);
        ...
        this.crown02.addChild(this.fiddlehead01);
        ...
        this.crown02.addChild(this.fiddlehead03);
