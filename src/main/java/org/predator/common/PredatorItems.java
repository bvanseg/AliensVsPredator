...
public class PredatorItems implements IPreInitEvent {
    ...
    public static final Item SHOVEL_CELTIC = new ItemSpade(AVPMaterials.Tools.CELTIC).setCreativeTab(Tab.MAIN).setRegistryName("tool.celtic.shovel");
    public static final Item PICKAXE_CELTIC = new ItemToolMaterialPickaxe(AVPMaterials.Tools.CELTIC).setCreativeTab(Tab.MAIN).setRegistryName("tool.celtic.pick");
    public static final Item AXE_CELTIC = new ItemToolMaterialAxe(AVPMaterials.Tools.CELTIC).setCreativeTab(Tab.MAIN).setRegistryName("tool.celtic.axe");
    public static final Item SWORD_CELTIC = new ItemSword(AVPMaterials.Tools.CELTIC).setCreativeTab(Tab.MAIN).setRegistryName("tool.celtic.sword");
    public static final Item HOE_CELTIC = new ItemHoe(AVPMaterials.Tools.CELTIC).setCreativeTab(Tab.MAIN).setRegistryName("tool.celtic.hoe");
    public static final Item ITEM_SPEAR = new ItemSpear(AVPMaterials.Tools.CELTIC).setCreativeTab(Tab.MAIN).setRegistryName("tool.celtic.spear");
    ...
    public static final Item ITEM_WRISTBRACER_BLADES = new HookedItem().setMaxStackSize(1).setMaxDamage(AVPMaterials.Tools.CELTIC.getMaxUses()).setCreativeTab(Tab.MAIN).setRegistryName("wristbracer.blades");
