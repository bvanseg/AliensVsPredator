...
public class BrainMemoryKeys {
	...
	public static final BrainMemoryKey<? super List<EntityPlayer>> PLAYER_ENTITIES = (BrainMemoryKey<? super List<EntityPlayer>>) BrainMemoryKey.create(AvpBrainMemoryTypes.ENTITIES);
