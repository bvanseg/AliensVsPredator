...
public class AVPEntities implements AVPRegistry {
    ...
    private static final RegistryObject<EntityType<DeaconAdultEntity>> DEACON_ADULT = registerEntityType("deacon_adult", EntityType.Builder.create(DeaconAdultEntity::new, EntityClassification.MONSTER).size(0.98F, 2.98F));
    private static final RegistryObject<EntityType<DeaconAdultEngineerEntity>> DEACON_ADULT_ENGINEER = registerEntityType("deacon_adult_engineer", EntityType.Builder.create(DeaconAdultEngineerEntity::new, EntityClassification.MONSTER).size(0.98F, 2.98F));
    ...
    private static final RegistryObject<EntityType<TrilobiteEntity>> TRILOBITE = registerEntityType("trilobite", EntityType.Builder.create(TrilobiteEntity::new, EntityClassification.MONSTER).size(0.98F, 0.98F));
    private static final RegistryObject<EntityType<TrilobiteBabyEntity>> TRILOBITE_BABY = registerEntityType("trilobite_baby", EntityType.Builder.create(TrilobiteBabyEntity::new, EntityClassification.MONSTER).size(0.98F, 0.98F));
