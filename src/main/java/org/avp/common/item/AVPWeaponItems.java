...
public final class AVPWeaponItems implements AVPRegistry {
    ...
    private static final DeferredRegister<Item> WEAPON_ITEMS = new DeferredRegister<>(
    ...
    private static RegistryObject<Item> registerItem(String name) {
        return WEAPON_ITEMS.register(
            name,
            () -> new WeaponItem(new Item.Properties().group(AVPItemGroups.WEAPON_ITEM_GROUP))
        );
    }
