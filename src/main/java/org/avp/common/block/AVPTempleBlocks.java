...
public class AVPTempleBlocks implements AVPRegistry {
    ...
    private static final DeferredRegister<Block> TEMPLE_BLOCKS = new DeferredRegister<>(ForgeRegistries.BLOCKS, AVPConstants.MOD_ID);

    private static final DeferredRegister<Item> TEMPLE_BLOCK_ITEMS = new DeferredRegister<>(ForgeRegistries.ITEMS, AVPConstants.MOD_ID);
    ...
    private static final RegistryObject<Block> TEMPLE_WALL_BASE = registerBlockWithItem("temple_wall_base", TEMPLE_BRICK_PROPERTIES);
    ...
    private static RegistryObject<Block> registerBlockWithItem(String name, Block.Properties properties) {
        ...
        TEMPLE_BLOCK_ITEMS.register(name, () -> new BlockItem(blockRegistryObject.get(), new Item.Properties().group(AVPItemGroups.BLOCK_ITEM_GROUP)));
