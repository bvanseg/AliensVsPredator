...
public class AVPPaddingBlocks implements AVPRegistry {
    ...
    private static final DeferredRegister<Block> PADDING_BLOCKS = new DeferredRegister<>(
        ForgeRegistries.BLOCKS,
        AVPConstants.MOD_ID
    );

    private static final DeferredRegister<Item> PADDING_BLOCK_ITEMS = new DeferredRegister<>(
    ...
    private static final RegistryObject<Block> PADDING_ORANGE_PANEL = registerBlockWithItem(
        "padding_orange_panel",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_ORANGE_PIPES = registerBlockWithItem(
        "padding_orange_pipes",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_ORANGE_SQUARE = registerBlockWithItem(
        "padding_orange_square",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_ORANGE_TILES = registerBlockWithItem(
        "padding_orange_tiles",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_WHITE_PANEL = registerBlockWithItem(
        "padding_white_panel",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_WHITE_PIPES = registerBlockWithItem(
        "padding_white_pipes",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_WHITE_SQUARE = registerBlockWithItem(
        "padding_white_square",
        PADDING_PROPERTIES
    );

    private static final RegistryObject<Block> PADDING_WHITE_TILES = registerBlockWithItem(
        "padding_white_tiles",
        PADDING_PROPERTIES
    );
