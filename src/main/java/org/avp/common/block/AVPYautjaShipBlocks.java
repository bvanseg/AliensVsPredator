...
public class AVPYautjaShipBlocks implements AVPRegistry {
    ...
    private static final DeferredRegister<Block> YAUTJA_SHIP_BLOCKS = new DeferredRegister<>(
        ForgeRegistries.BLOCKS,
        AVPConstants.MOD_ID
    );

    private static final DeferredRegister<Item> YAUTJA_SHIP_BLOCK_ITEMS = new DeferredRegister<>(
    ...
    private static final RegistryObject<Block> YAUTJA_SHIP_BRICK = registerBlockWithItem(
        "yautja_ship_brick",
        YAUTJA_SHIP_PROPERTIES
    );

    private static final RegistryObject<Block> YAUTJA_SHIP_DECOR_1 = registerBlockWithItem(
        "yautja_ship_decor_1",
        YAUTJA_SHIP_PROPERTIES
    );

    private static final RegistryObject<Block> YAUTJA_SHIP_DECOR_2 = registerBlockWithItem(
        "yautja_ship_decor_2",
        YAUTJA_SHIP_PROPERTIES
    );

    private static final RegistryObject<Block> YAUTJA_SHIP_DECOR_3 = registerBlockWithItem(
        "yautja_ship_decor_3",
        YAUTJA_SHIP_PROPERTIES
    );

    private static final RegistryObject<Block> YAUTJA_SHIP_PANEL = registerBlockWithItem(
        "yautja_ship_panel",
        YAUTJA_SHIP_PROPERTIES
    );

    private static final RegistryObject<Block> YAUTJA_SHIP_SUPPORT_PILLAR = registerBlockWithItem(
        "yautja_ship_support_pillar",
        YAUTJA_SHIP_PROPERTIES
    );

    private static final RegistryObject<Block> YAUTJA_SHIP_WALL_BASE = registerBlockWithItem(
    ...
    private static RegistryObject<Block> registerBlockWithItem(String name, Block.Properties properties) {
        ...
        YAUTJA_SHIP_BLOCK_ITEMS.register(
            name,
