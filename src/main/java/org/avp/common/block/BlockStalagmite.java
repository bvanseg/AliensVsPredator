...
public class BlockStalagmite extends Block
{
    ...
    {
        return state.getBlock() == PrometheusVardaBlocks.UNIDIRT || state.getBlock() == PrometheusVardaBlocks.UNISTONE || state.getMaterial() == Material.GROUND || state.getMaterial() == Material.ROCK;
    }
