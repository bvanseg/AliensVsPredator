...
public class FirearmProfiles
{
    ...
    public static final FirearmProfile M41A   = new FirearmProfile(Classification.ASSAULT_RIFLE).setAmmoMax(99).setRecoil(0.5F).setRoundsPerMinute(900).setReloadTime(120).setSound(Sounds.WEAPON_PULSERIFLE).setSoundLength(0.9D);
