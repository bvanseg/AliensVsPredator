...
public class Resources
{
    ...
    {
        public final TexturedModel<ModelAethon>                 AETHON                         = new TexturedModel(new ModelAethon(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/aethon.png"));
        ...
        public final TexturedModel<ModelEngineer>               SPACE_JOCKEY                   = new TexturedModel(new ModelEngineer(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/engineer.png"));
        public final TexturedModel<ModelAmpule>                 AMPULE                         = new TexturedModel(new ModelAmpule(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/ampule.png"));
        public final TexturedModel<ModelTransformer>            TRANSFORMER                    = new TexturedModel(new ModelTransformer(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/transformer.png"));
        public final TexturedModel<ModelSolarPanel>             SOLAR_PANEL                    = new TexturedModel(new ModelSolarPanel(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/solarpanel.png"));
        public final TexturedModel<ModelSatelliteDish>          SATELLITE_DISH                 = new TexturedModel(new ModelSatelliteDish(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/satellite-dish.png"));
        public final TexturedModel<ModelPowercell>              POWERCELL                      = new TexturedModel(new ModelPowercell(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/powercell.png"));
        public final TexturedModel<ModelPowercell>              POWERCELL_LIQUID               = new TexturedModel(new ModelPowercell(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/powercellliquid.png"));
        public final TexturedModel<ModelDrone>                  DRONE_BASIC                    = new TexturedModel(new ModelDrone(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/drone_basic.png"));
        public final TexturedModel<ModelDrone>                  DRONE_ADVANCED                 = new TexturedModel(new ModelDrone(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/drone_advanced.png"));
        ...
        public final TexturedModel<ModelM56SG>                  M56SG                          = new TexturedModel(new ModelM56SG(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/m56sg.png"));
        public final TexturedModel<ModelAK47>                   AK47                           = new TexturedModel(new ModelAK47(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/ak-47.png"));
        public final TexturedModel<ModelM4>                     M4                             = new TexturedModel(new ModelM4(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/m4.png"));
        public final TexturedModel<ModelSniper>                 SNIPER                         = new TexturedModel(new ModelSniper(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/sniper.png"));
        public final TexturedModel<ModelM40>                    M40GRENADE                     = new TexturedModel(new ModelM40(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/m40.png"));
        public final TexturedModel<ModelM40>                    M40GRENADE_INCENDIARY          = new TexturedModel(new ModelM40(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/m40incendiary.png"));
        public final TexturedModel<ModelMotionTracker>          MOTIONTRACKER                  = new TexturedModel(new ModelMotionTracker(), new Texture(AliensVsPredator.Properties.ID, "textures/items/models/motiontracker.png"));
        public final TexturedModel<ModelTurret>                 TURRET                         = new TexturedModel(new ModelTurret(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/turret.png"));
        public final TexturedModel<ModelWorkstation>            WORKSTATION                    = new TexturedModel(new ModelWorkstation(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/workstation.png"));
        public final TexturedModel<ModelWorkstation>            WORKSTATION_MASK               = new TexturedModel(new ModelWorkstation(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/workstation-on.png"));
        public final TexturedModel<ModelLightPanel>             LIGHT_PANEL                    = new TexturedModel(new ModelLightPanel(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/lightpanel.png"));
        public final TexturedModel<ModelCryostasisTube>         CRYOSTASIS_TUBE                = new TexturedModel(new ModelCryostasisTube(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/cryostasistube.png"));
        public final TexturedModel<ModelCryostasisTube>         CRYOSTASIS_TUBE_MASK           = new TexturedModel(new ModelCryostasisTube(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/cryostasistube-mask.png"));
        public final TexturedModel<ModelCryostasisTube>         CRYOSTASIS_TUBE_MASK_CRACKED   = new TexturedModel(new ModelCryostasisTube(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/cryostasistube-cracked-mask.png"));
        public final TexturedModel<ModelCryostasisTube>         CRYOSTASIS_TUBE_MASK_SHATTERED = new TexturedModel(new ModelCryostasisTube(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/cryostasistube-shattered-mask.png"));
        public final TexturedModel<ModelStasisMechanism>        STASIS_MECHANISM               = new TexturedModel(new ModelStasisMechanism(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/stasis-mechanism.png"));
        public final TexturedModel<ModelStasisMechanism>        STASIS_MECHANISM_MASK          = new TexturedModel(new ModelStasisMechanism(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/stasis-mechanism-mask.png"));
        public final TexturedModel<ModelMedpod>                 MEDPOD                         = new TexturedModel(new ModelMedpod(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/medpod.png"));
        public final TexturedModel<ModelMedpod>                 MEDPOD_MASK                    = new TexturedModel(new ModelMedpod(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/medpod-on.png"));
        ...
        public final TexturedModel<ModelCCFL>                   CCFL_BALLAST                   = new TexturedModel(new ModelCCFL(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/ccfl_ballast.png"));
        public final TexturedModel<ModelCCFL>                   CCFL_TUBE_ON                   = new TexturedModel(new ModelCCFL(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/ccfl_on.png"));
        public final TexturedModel<ModelCCFL>                   CCFL_TUBE_OFF                  = new TexturedModel(new ModelCCFL(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/ccfl_off.png"));
        ...
        public final TexturedModel<ModelChestbursterRunner>     CHESTBUSTER_RUNNER             = new TexturedModel(new ModelChestbursterRunner(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/chestburster_runner.png"));
        public final TexturedModel<ModelFacehugger>             FACEHUGGER                     = new TexturedModel(new ModelFacehugger(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/facehugger.png"));
        public final TexturedModel<ModelRoyalFacehugger>        ROYALFACEHUGGER                = new TexturedModel(new ModelRoyalFacehugger(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/royalfacehugger.png"));
        public final TexturedModel<ModelMarine>                 MARINE                         = new TexturedModel(new ModelMarine(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/marine.png"));
        public final TexturedModel<ModelOvamorph>               OVAMORPH                       = new TexturedModel(new ModelOvamorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/alienegg.png"));
        public final TexturedModel<ModelPredalien>              PREDALIEN                      = new TexturedModel(new ModelPredalien(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/predalien.png"));
        public final TexturedModel<ModelPraetorian>             PRAETORIAN                     = new TexturedModel(new ModelPraetorian(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/praetorian.png"));
        public final TexturedModel<ModelWarrior>                WARRIOR                        = new TexturedModel(new ModelWarrior(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/warrior.png"));
        public final TexturedModel<ModelWarrior>                WARRIOR_BLOOD                  = new TexturedModel(new ModelWarrior(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/warrior_blood.png"));
        public final TexturedModel<ModelDrone>                  DRONE_BASIC_BLOOD              = new TexturedModel(new ModelDrone(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/drone_basic_blood.png"));
        public final TexturedModel<ModelDrone>                  DRONE_ADVANCED_BLOOD           = new TexturedModel(new ModelDrone(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/drone_advanced_blood.png"));
        public final TexturedModel<ModelHammerpede>             HAMMERPEDE                     = new TexturedModel(new ModelHammerpede(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/hammerpede.png"));
        public final TexturedModel<ModelTrilobite>              TRILOBITE                      = new TexturedModel(new ModelTrilobite(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/trilobite.png"));
        public final TexturedModel<ModelDeaconShark>            DEACON_SHARK                   = new TexturedModel(new ModelDeaconShark(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/deacon_shark.png"));
        public final TexturedModel<ModelDeacon>                 DEACON                         = new TexturedModel(new ModelDeacon(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/deacon.png"));
        public final TexturedModel<ModelAqua>                   AQUA_XENOMORPH                 = new TexturedModel(new ModelAqua(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/aqua.png"));
        public final TexturedModel<ModelAqua>                   AQUA_XENOMORPH_MASK            = new TexturedModel(new ModelAqua(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/aqua_glow.png"));
        public final TexturedModel<ModelMatriarch>              MATRIARCH                      = new TexturedModel(new ModelMatriarch(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/matriarch.png"));
        public final TexturedModel<ModelMatriarch>              MATRIARCH_MASK                 = new TexturedModel(new ModelMatriarch(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/matriarch_mask.png"));
        public final TexturedModel<ModelYautja>                 YAUTJA_WARRIOR                 = new TexturedModel(new ModelYautja(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautja.png"));
        public final TexturedModel<ModelYautja>                 YAUTJA_BERSERKER               = new TexturedModel(new ModelYautja(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautja_berserker.png"));
        public final TexturedModel<ModelSpitter>                SPITTER                        = new TexturedModel(new ModelSpitter(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/spitter.png"));
        public final TexturedModel<ModelSpitter>                SPITTER_MASK                   = new TexturedModel(new ModelSpitter(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/spitter_glow.png"));
        public final TexturedModel<ModelCrusher>                CRUSHER                        = new TexturedModel(new ModelCrusher(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/crusher.png"));
        public final TexturedModel<SpecialModelBiped>           COMBAT_SYNTHETIC               = new TexturedModel(new SpecialModelBiped(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/combat_synthetic.png"));
        public final TexturedModel<ModelSupplyChute>            SUPPLY_CHUTE                   = new TexturedModel(new ModelSupplyChute(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/supplychute.png"));
        public final TexturedModel<ModelSupplyChute>            SUPPLY_CHUTE_MARINES           = new TexturedModel(new ModelSupplyChute(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/supplychute.marines.png"));
        public final TexturedModel<ModelSupplyChute>            SUPPLY_CHUTE_SEEGSON           = new TexturedModel(new ModelSupplyChute(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/supplychute.seegson.png"));
        public final TexturedModel<SpecialModelBiped>           BIPED                          = new TexturedModel(new SpecialModelBiped(), new Texture(""));
        public final TexturedModel<ModelLaserMine>              LASER_MINE                     = new TexturedModel(new ModelLaserMine(), new Texture(AliensVsPredator.Properties.ID, "textures/misc/proximity-mine.png"));
        public final TexturedModel<ModelDNASynthesizer>         DNA_SYNTHESIZER                = new TexturedModel(new ModelDNASynthesizer(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/dna-synthesizer.png"));
        public final TexturedModel<ModelHiveResin>              HIVE_RESIN                     = new TexturedModel(new ModelHiveResin(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/hive-resin.png"));
        public final TexturedModel<ModelGooMutant>              GOO_MUTANT                     = new TexturedModel(new ModelGooMutant(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/goomutant.png"));
        public final TexturedModel<ModelWarrior>                DRONE_SKULL                    = new TexturedModel(new ModelWarrior(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/xenomorphskullgiger.png"));
        public final TexturedModel<ModelWarrior>                WARRIOR_SKULL                  = new TexturedModel(new ModelWarrior(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/xenomorphskullwarrior.png"));
        public final TexturedModel<ModelYautja>                 YAUTJA_SKULL                   = new TexturedModel(new ModelYautja(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautjaskull.png"));
        public final TexturedModel<ModelMatriarch>              QUEEN_SKULL                    = new TexturedModel(new ModelMatriarch(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/queenskull.png"));
        public final TexturedModel<ModelOctohugger>             OCTOHUGGER                     = new TexturedModel(new ModelOctohugger(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/octohugger.png"));
        public final TexturedModel<ModelBelugaburster>          BELUGABURSTER                  = new TexturedModel(new ModelBelugaburster(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/belugaburster.png"));
        public final TexturedModel<ModelBelugamorph>            BELUGAMORPH                    = new TexturedModel(new ModelBelugamorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/belugamorph.png"));
        public final TexturedModel<ModelRedstoneFluxGenerator>  RFGENERATOR                    = new TexturedModel(new ModelRedstoneFluxGenerator(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/redstonefluxgenerator.png"));
        public final TexturedModel<ModelBabyhead>               BABYHEAD                       = new TexturedModel(new ModelBabyhead(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/babyhead.png"));
        public final TexturedModel<ModelBatXenomorph>           BAT_XENO                       = new TexturedModel(new ModelBatXenomorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/batxeno.png"));
        public final TexturedModel<ModelBoiler>                 BOILER                         = new TexturedModel(new ModelBoiler(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/boiler.png"));
        public final TexturedModel<ModelBoiler>                 BOILER_MASK                    = new TexturedModel(new ModelBoiler(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/boiler_glow.png"));
        public final TexturedModel<ModelDracoburster>           DRACOBURSTER                   = new TexturedModel(new ModelDracoburster(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/dracoburster.png"));
        public final TexturedModel<ModelDracomorph>             DRACOMORPH                     = new TexturedModel(new ModelDracomorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/dracomorph.png"));
        public final TexturedModel<ModelDracoOvamorph>          DRACO_OVAMORPH                 = new TexturedModel(new ModelDracoOvamorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/dracomorphegg.png"));
        public final TexturedModel<ModelMutantYautja>           MUTANT_YAUTJA                  = new TexturedModel(new ModelMutantYautja(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautjamutant.png"));
        public final TexturedModel<ModelMyceliomorph>           MYCELIOMORPH                   = new TexturedModel(new ModelMyceliomorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/myceliomorph.png"));
        public final TexturedModel<ModelMyceliomorph>           MYCELIOMORPH_MASK              = new TexturedModel(new ModelMyceliomorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/myceliomorph_glow.png"));
        public final TexturedModel<ModelPantheramorph>          PANTHERAMORPH                  = new TexturedModel(new ModelPantheramorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/pantheramorph.png"));
        public final TexturedModel<ModelPredatorHound>          PREDATOR_HOUND                 = new TexturedModel(new ModelPredatorHound(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/predatorhound.png"));
        public final TexturedModel<ModelUrsuidae>               URSUIDAE                       = new TexturedModel(new ModelUrsuidae(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/vardaboar.png"));
        public final TexturedModel<ModelVardaMonkey>            VARDA_MONKEY                   = new TexturedModel(new ModelVardaMonkey(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/vardamonkey.png"));

        /** New xenomorph model format **/
        public final TexturedModel<ModelUltramorph>             ULTRAMORPH                     = new TexturedModel(new ModelUltramorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/ultramorph.png"));
