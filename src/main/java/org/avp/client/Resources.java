...
public class Resources
{
    ...
    public static class Models
    {
        ...
        public final MapModelTexture<ModelNauticomorph>           NAUTICOMORPH_XENOMORPH         = new MapModelTexture(new ModelNauticomorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/nauticomorph.png"));
        public final MapModelTexture<ModelNauticomorph>           NAUTICOMORPH_XENOMORPH_MASK    = new MapModelTexture(new ModelNauticomorph(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/nauticomorph_glow.png"));
        ...
        public final MapModelTexture<ModelQueenSkull>             MATRIARCH_SKULL                = new MapModelTexture(new ModelQueenSkull(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/skulls/queenskull.png"));
        public final MapModelTexture<ModelBiomaskClassic>         BIOMASK_CLASSIC                = new MapModelTexture(new ModelBiomaskClassic(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautja/yautja.png"));
        public final MapModelTexture<ModelBiomaskBerserker>       BIOMASK_BERSERKER              = new MapModelTexture(new ModelBiomaskBerserker(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautja/yautja_berserker.png"));
        public final MapModelTexture<ModelBiomaskFalconer>        BIOMASK_FALCONER               = new MapModelTexture(new ModelBiomaskFalconer(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautja/yautja_falconer.png"));
        public final MapModelTexture<ModelBiomaskTracker>         BIOMASK_TRACKER                = new MapModelTexture(new ModelBiomaskTracker(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/yautja/yautja_tracker.png"));
        public final MapModelTexture<ModelAethonHead>             HEAD_AETHON                    = new MapModelTexture(new ModelAethonHead(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/aethon/aethon.png"));
        public final MapModelTexture<ModelProtomorphSkull>        PROTOMORPH_SKULL               = new MapModelTexture(new ModelProtomorphSkull(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/skulls/protomorph_skull.png"));
        public final MapModelTexture<ModelNeomorphSkull>          NEOMORPH_SKULL                 = new MapModelTexture(new ModelNeomorphSkull(), new Texture(AliensVsPredator.Properties.ID, "textures/tile/skulls/neomorph_skull.png"));
        public final MapModelTexture<ModelGigerAlienHead>         GIGER_ALIEN_HEAD               = new MapModelTexture(new ModelGigerAlienHead(), new Texture(AliensVsPredator.Properties.ID, "textures/mob/gigeralien.png"));
