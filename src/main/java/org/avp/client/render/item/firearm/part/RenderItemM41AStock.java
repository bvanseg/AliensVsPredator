...
public class RenderItemM41AStock extends ItemRendererGroup<ModelM41A>
{
    public RenderItemM41AStock(MapModelTexture<ModelM41A> model, ModelRenderer... modelRenderers)
    {
