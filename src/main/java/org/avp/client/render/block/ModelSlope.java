...
{
    public static final ResourceLocation MODEL_LOCATION = new ResourceLocation(AliensVsPredator.Properties.ID, "block/slope.obj");
    public static final ResourceLocation TEXTURE        = new ResourceLocation(AliensVsPredator.Properties.ID, "blocks/reflection");
