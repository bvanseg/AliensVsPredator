...
public class OvamorphModel extends EntityModel<OvamorphEntity> {
    ...
    public OvamorphModel() {
        ...
        lFrontLobeChild_r1.cubeList.add(
            new ModelBox(lFrontLobeChild_r1, 37, 0, -1.25F, -1.65F, -0.75F, 2, 2, 2, 0.0F, true)
        );
        ...
        lFrontLobeChild_r2.cubeList.add(
            new ModelBox(lFrontLobeChild_r2, 37, 0, -0.75F, -1.65F, -0.75F, 2, 2, 2, 0.0F, false)
        );
        ...
        lBackLobeChild_r1.cubeList.add(
            new ModelBox(lBackLobeChild_r1, 37, 6, -0.75F, -1.65F, -1.25F, 2, 2, 2, 0.0F, false)
        );
        ...
        lBackLobeChild_r2.cubeList.add(
            new ModelBox(lBackLobeChild_r2, 37, 6, -1.25F, -1.65F, -1.25F, 2, 2, 2, 0.0F, true)
        );
    }
