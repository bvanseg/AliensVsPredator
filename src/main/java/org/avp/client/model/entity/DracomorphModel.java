...
public class DracomorphModel extends EntityModel<DracomorphEntity> {
    ...
    public DracomorphModel() {
        ...
        lShoulderBlade_r1.cubeList.add(
            new ModelBox(lShoulderBlade_r1, 146, 34, -5.6424F, -2.4422F, -4.6468F, 2, 3, 10, 0.0F, true)
        );
        ...
        lShoulderBlade_r2.cubeList.add(
            new ModelBox(lShoulderBlade_r2, 146, 34, 3.6424F, -2.4422F, -4.6468F, 2, 3, 10, 0.0F, false)
        );
        ...
        gRightWingForearm.cubeList.add(
            new ModelBox(gRightWingForearm, 149, 0, -0.5F, -1.0F, 0.0F, 1, 2, 10, 0.0F, false)
        );
