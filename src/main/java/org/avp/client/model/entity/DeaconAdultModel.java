...
public class DeaconAdultModel extends EntityModel<DeaconAdultEntity> {
    ...
    public DeaconAdultModel() {
        ...
        lShoulderRidge02_r1.cubeList.add(
            new ModelBox(lShoulderRidge02_r1, 31, 25, 2.5F, -45.5F, -2.9F, 2, 2, 4, 0.0F, true)
        );
        ...
        lShoulderRidge04_r1.cubeList.add(
            new ModelBox(lShoulderRidge04_r1, 31, 41, 2.5F, -45.5F, 4.4F, 2, 2, 3, 0.0F, true)
        );
        ...
        lShoulderRidge03_r1.cubeList.add(
            new ModelBox(lShoulderRidge03_r1, 31, 33, 2.5F, -45.6F, 0.7F, 2, 2, 4, 0.0F, true)
        );
        ...
        lShoulderRidge02_r2.cubeList.add(
            new ModelBox(lShoulderRidge02_r2, 31, 33, -4.5F, -45.6F, 0.7F, 2, 2, 4, 0.0F, false)
        );
        ...
        lShoulderRidge03_r2.cubeList.add(
            new ModelBox(lShoulderRidge03_r2, 31, 41, -4.5F, -45.5F, 4.4F, 2, 2, 3, 0.0F, false)
        );
        ...
        lShoulderRidge01_r1.cubeList.add(
            new ModelBox(lShoulderRidge01_r1, 31, 25, -4.5F, -45.5F, -2.9F, 2, 2, 4, 0.0F, false)
        );
