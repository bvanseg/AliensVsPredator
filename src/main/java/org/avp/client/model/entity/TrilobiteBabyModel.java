...
public class TrilobiteBabyModel extends EntityModel<TrilobiteBabyEntity> {
    ...
    public TrilobiteBabyModel() {
        ...
        gBackLeftTentacle1.cubeList.add(
            new ModelBox(gBackLeftTentacle1, 0, 13, -1.0F, 0.0F, -1.0F, 2, 5, 2, -0.1F, false)
        );
        ...
        gBackLeftTentacle2.cubeList.add(
            new ModelBox(gBackLeftTentacle2, 0, 13, -1.0F, -0.3F, -1.0F, 2, 5, 2, -0.25F, false)
        );
        ...
        gBackLeftTentacle3.cubeList.add(
            new ModelBox(gBackLeftTentacle3, 0, 13, -1.0F, -0.5F, -1.0F, 2, 5, 2, -0.4F, false)
        );
        ...
        gBackRightTentacle1.cubeList.add(
            new ModelBox(gBackRightTentacle1, 0, 13, -1.0F, 0.0F, -1.0F, 2, 5, 2, -0.1F, true)
        );
        ...
        gBackRightTentacle2.cubeList.add(
            new ModelBox(gBackRightTentacle2, 0, 13, -1.0F, -0.3F, -1.0F, 2, 5, 2, -0.25F, true)
        );
        ...
        gBackRightTentacle3.cubeList.add(
            new ModelBox(gBackRightTentacle3, 0, 13, -1.0F, -0.5F, -1.0F, 2, 5, 2, -0.4F, true)
        );
        ...
        gFrontLeftTentacle1.cubeList.add(
            new ModelBox(gFrontLeftTentacle1, 0, 13, -1.0F, 0.0F, -1.0F, 2, 5, 2, -0.1F, false)
        );
        ...
        gFrontLeftTentacle2.cubeList.add(
            new ModelBox(gFrontLeftTentacle2, 0, 13, -1.0F, -0.3F, -1.0F, 2, 5, 2, -0.25F, false)
        );
        ...
        gFrontLeftTentacle3.cubeList.add(
            new ModelBox(gFrontLeftTentacle3, 0, 13, -1.0F, -0.5F, -1.0F, 2, 5, 2, -0.4F, false)
        );
        ...
        gFrontRightTentacle1.cubeList.add(
            new ModelBox(gFrontRightTentacle1, 0, 13, -1.0F, 0.0F, -1.0F, 2, 5, 2, -0.1F, true)
        );
        ...
        gFrontRightTentacle2.cubeList.add(
            new ModelBox(gFrontRightTentacle2, 0, 13, -1.0F, -0.3F, -1.0F, 2, 5, 2, -0.25F, true)
        );
        ...
        gFrontRightTentacle3.cubeList.add(
            new ModelBox(gFrontRightTentacle3, 0, 13, -1.0F, -0.5F, -1.0F, 2, 5, 2, -0.4F, true)
        );
    ...
    @Override
    public void render(
        TrilobiteBabyEntity trilobiteBabyEntity,
        float f,
        float f1,
        float f2,
        float f3,
