...
public class BelugabursterModel extends EntityModel<BelugabursterEntity> {
	...
	public BelugabursterModel() {
		...
		gRightArmFrontMiddle.cubeList.add(new ModelBox(gRightArmFrontMiddle, 70, 14, -0.5F, -1.0F, 0.0F, 1, 2, 3, 0.0F, false));
		...
		gRightArmMiddle.cubeList.add(new ModelBox(gRightArmMiddle, 71, 21, -0.534F, -3.9801F, -0.9503F, 1, 4, 2, 0.0F, false));
		...
		gRightArmBackMiddle.cubeList.add(new ModelBox(gRightArmBackMiddle, 71, 29, -0.534F, -4.9801F, -0.4503F, 1, 5, 1, 0.0F, false));
		...
		gRightArmEnd.cubeList.add(new ModelBox(gRightArmEnd, 71, 29, -0.5261F, -4.9804F, -0.4606F, 1, 5, 1, 0.0F, false));
		...
		gLeftArmFrontMiddle.cubeList.add(new ModelBox(gLeftArmFrontMiddle, 70, 14, -0.5F, -1.0F, 0.0F, 1, 2, 3, 0.0F, true));
		...
		gLeftArmMiddle.cubeList.add(new ModelBox(gLeftArmMiddle, 71, 21, -0.466F, -3.9801F, -0.9503F, 1, 4, 2, 0.0F, true));
		...
		gLeftArmBackMiddle.cubeList.add(new ModelBox(gLeftArmBackMiddle, 71, 29, -0.466F, -4.9801F, -0.4503F, 1, 5, 1, 0.0F, true));
	...
	@Override
	public void render(BelugabursterEntity belugabursterEntity, float f, float f1, float f2, float f3, float f4, float f5) {
		root.render(f5);
	}
