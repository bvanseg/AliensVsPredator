...
public class BelugamorphModel extends EntityModel<BelugamorphEntity> {
	...
	public BelugamorphModel() {
		...
		gSmallDorsalTube.cubeList.add(new ModelBox(gSmallDorsalTube, 1, 51, -1.0F, -1.0F, -0.4F, 2, 2, 3, -0.1F, false));
		...
		gLowerLeftDorsalTube.cubeList.add(new ModelBox(gLowerLeftDorsalTube, 0, 50, -1.0F, -1.0F, -0.4F, 2, 2, 4, 0.0F, true));
		...
		gLowerRightDorsalTube.cubeList.add(new ModelBox(gLowerRightDorsalTube, 0, 50, -1.0F, -1.0F, -0.4F, 2, 2, 4, 0.0F, false));
		...
		gRightForearm.cubeList.add(new ModelBox(gRightForearm, 85, 35, -0.95F, -0.3217F, -1.2214F, 2, 8, 2, -0.1F, false));
