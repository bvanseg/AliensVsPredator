...
public class OvamorphDracoModel extends EntityModel<OvamorphDracoEntity> {
	...
	public OvamorphDracoModel() {
		...
		rFrontLobe2Child_r1.cubeList.add(new ModelBox(rFrontLobe2Child_r1, 28, 0, -1.25F, -1.25F, -0.75F, 2, 2, 2, 0.0F, false));
		...
		rFrontLobe2Child_r2.cubeList.add(new ModelBox(rFrontLobe2Child_r2, 28, 6, -0.75F, -1.25F, -0.75F, 2, 2, 2, 0.0F, true));
		...
		rBackLobeChild_r1.cubeList.add(new ModelBox(rBackLobeChild_r1, 28, 6, -1.25F, -1.25F, -1.25F, 2, 2, 2, 0.0F, false));
		...
		rBackLobeChild_r2.cubeList.add(new ModelBox(rBackLobeChild_r2, 28, 0, -1.25F, -1.25F, -1.25F, 2, 2, 2, 0.0F, false));
	}

	@Override
	public void render(OvamorphDracoEntity ovamorphDracoEntity, float f, float f1, float f2, float f3, float f4, float f5) {
		root.render(f5);
	}
