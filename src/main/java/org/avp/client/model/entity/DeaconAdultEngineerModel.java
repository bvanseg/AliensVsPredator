...
public class DeaconAdultEngineerModel extends EntityModel<DeaconAdultEngineerEntity> {
    ...
    public DeaconAdultEngineerModel() {
        ...
        rShoulderRidge03_r1.cubeList.add(
            new ModelBox(rShoulderRidge03_r1, 31, 33, -4.5F, -55.7F, 1.8F, 2, 2, 4, 0.0F, false)
        );
        ...
        rShoulderRidge04_r1.cubeList.add(
            new ModelBox(rShoulderRidge04_r1, 30, 41, -4.5F, -55.6F, 5.5F, 2, 2, 3, 0.0F, false)
        );
        ...
        rShoulderRidge02_r1.cubeList.add(
            new ModelBox(rShoulderRidge02_r1, 31, 25, -4.5F, -55.6F, -1.8F, 2, 2, 4, 0.0F, false)
        );
        ...
        rShoulderRidge02_r2.cubeList.add(
            new ModelBox(rShoulderRidge02_r2, 31, 33, 2.5F, -55.7F, 1.8F, 2, 2, 4, 0.0F, true)
        );
        ...
        rShoulderRidge03_r2.cubeList.add(
            new ModelBox(rShoulderRidge03_r2, 30, 41, 2.5F, -55.6F, 5.5F, 2, 2, 3, 0.0F, true)
        );
        ...
        rShoulderRidge01_r1.cubeList.add(
            new ModelBox(rShoulderRidge01_r1, 31, 25, 2.5F, -55.6F, -1.8F, 2, 2, 4, 0.0F, true)
        );
        ...
        headLower03_r1.cubeList.add(
            new ModelBox(headLower03_r1, 116, 46, -1.0F, -1.0313F, 2.8506F, 2, 1, 3, 0.0F, false)
        );
        ...
        headLower02_r1.cubeList.add(
            new ModelBox(headLower02_r1, 113, 13, -1.5F, -0.801F, -0.9281F, 3, 1, 4, 0.0F, false)
        );
        ...
        rArmSpike_r1.cubeList.add(
            new ModelBox(rArmSpike_r1, 32, 47, -1.0918F, -3.8481F, -1.7622F, 2, 4, 2, 0.0F, true)
        );
        ...
        rArmSpike_r2.cubeList.add(
            new ModelBox(rArmSpike_r2, 32, 47, -0.9082F, -3.8481F, -1.7622F, 2, 4, 2, 0.0F, false)
        );
        ...
        lKneeSpike_r1.cubeList.add(
            new ModelBox(lKneeSpike_r1, 101, 0, 0.2561F, -3.1371F, -2.454F, 3, 3, 4, 0.0F, false)
        );
        ...
        lKneeSpike_r2.cubeList.add(
            new ModelBox(lKneeSpike_r2, 101, 0, -3.2561F, -3.1371F, -2.454F, 3, 3, 4, 0.0F, true)
        );
        ...
        tailBlade02_r1.cubeList.add(
            new ModelBox(tailBlade02_r1, 21, 60, -0.1466F, -2.0141F, -0.8534F, 1, 3, 1, -0.1F, false)
        );
    }

    @Override
    public void render(
        DeaconAdultEngineerEntity deaconAdultEngineerEntity,
        float f,
        float f1,
        float f2,
        float f3,
