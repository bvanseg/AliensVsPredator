...
{
    private static final FirearmProfile SNIPER                   = new FirearmProfile(Classification.RIFLE).setAmmoMax(6).setRecoil(1.5F).setRoundsPerMinute(30).setReloadTime(150).setSound(Sounds.SOUND_WEAPON_SNIPER);
    private static final FirearmProfile PISTOL                   = new FirearmProfile(Classification.PISTOL).setAmmoMax(12).setRecoil(2.0F).setRoundsPerMinute(80).setReloadTime(120).setSound(Sounds.SOUND_WEAPON_GUNSHOT);
    private static final FirearmProfile M4                       = new FirearmProfile(Classification.ASSAULT_RIFLE).setAmmoMax(24).setRecoil(0.5F).setRoundsPerMinute(800).setReloadTime(120).setSound(Sounds.SOUND_WEAPON_GUNSHOT).setSoundLength(0.75D);
    private static final FirearmProfile M41A                     = new FirearmProfile(Classification.ASSAULT_RIFLE).setAmmoMax(99).setRecoil(0.5F).setRoundsPerMinute(900).setReloadTime(120).setSound(Sounds.SOUND_WEAPON_PULSERIFLE).setSoundLength(1.25D);
    private static final FirearmProfile M56SG                    = new FirearmProfile(Classification.LIGHT_MACHINE_GUN).setAmmoMax(500).setRecoil(0.2F).setRoundsPerMinute(1200).setReloadTime(120).setSound(Sounds.SOUND_WEAPON_M56SG);
    private static final FirearmProfile AK47                     = new FirearmProfile(Classification.ASSAULT_RIFLE).setAmmoMax(32).setRecoil(0.6F).setRoundsPerMinute(600).setReloadTime(100).setSound(Sounds.SOUND_WEAPON_GUNSHOT);
    ...
    public Item                         itemFuelTank             = new HookedItem().setMaxStackSize(1).setMaxDamage(64);
    public Item                         itemM240ICU              = new ItemM240IncineratorUnit(itemFuelTank);
    public Item                         itemNostromoFlamethrower = new ItemNostromoFlamethrower(itemFuelTank);
    public Item                         itemPistol               = new ItemFirearm(PISTOL);
    public Item                         itemM4                   = new ItemFirearm(M4).setFull3D();
    ...
    public Item                         itemSniper               = new ItemFirearm(SNIPER).setFull3D();
    ...
    public Item                         itemM41A                 = new ItemFirearm(M41A).setFull3D();
    ...
    public Item                         itemM56SG                = new ItemFirearm(M56SG).setFull3D();
    ...
    public Item                         itemAK47                 = new ItemFirearm(AK47).setFull3D();
    ...
    public void pre(FMLPreInitializationEvent event)
    {
        ...
        register("gun.flamethrower.nostromo", itemNostromoFlamethrower).setCreativeTab(AliensVsPredator.tabMain());
        ...
        register("ammo.flamethrower", itemFuelTank).setCreativeTab(AliensVsPredator.tabMain());
