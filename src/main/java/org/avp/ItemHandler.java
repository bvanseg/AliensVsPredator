...
public class ItemHandler
{
    ...
    public static final Item itemAmmoSMG                = new ItemAmmunition(Classification.SUB_MACHINE_GUN).setCreativeTab(Tab.MAIN).setRegistryName("ammo.smg");
    ...
    public static final Item itemProcessor              = new HookedItem().setCreativeTab(Tab.CRAFTING).setRegistryName("part.processor");
    public static final Item itemSolidStateDrive        = new HookedItem().setCreativeTab(Tab.CRAFTING).setRegistryName("part.solidstatedrive");
    ...
    public static final Item itemLedDisplay             = new HookedItem().setCreativeTab(Tab.CRAFTING).setRegistryName("part.led.display");
