...
public final class AVPElectronicItems implements AVPRegistry {
    ...
    private static final DeferredRegister<Item> ELECTRONIC_ITEMS = new DeferredRegister<>(ForgeRegistries.ITEMS, AVPConstants.MOD_ID);
    ...
    private static RegistryObject<Item> registerItem(String name) {
        return ELECTRONIC_ITEMS.register(name, () -> new Item(new Item.Properties().group(AVPItemGroups.ELECTRONICS_ITEM_GROUP)));
    }
