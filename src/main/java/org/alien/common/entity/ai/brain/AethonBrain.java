...
public class AethonBrain extends AbstractEntityBrain<EntityAethon> {
	...
	public void init() {
		...
		this.addTask(new BrainTaskAdapter(new EntityAINearestAttackableTarget<>(entity, EntityCreature.class, 0, true, false, EntitySelectorAethon.instance)));
		this.addTask(new BrainTaskAdapter(new EntityAINearestAttackableTarget<>(entity, EntityPlayer.class, 0, true, false, EntitySelectorAethon.instance)));
	}
}
