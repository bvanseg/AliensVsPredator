...
import org.prometheus.common.block.init.PrometheusEngineerBlocks;
...
public class EntityAcidPool extends EntityLiquidPool
{
    ...
    static
    {
        ...
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_BRICK_0);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_BRICK_1);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_BRICK_2);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_BRICK_3);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_COLUMN_1);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_COLUMN_2);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_FLOOR);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_GRAVEL);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_MATERIAL_0);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_MATERIAL_1);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_MATERIAL_2);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_ROCK_0);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_ROCK_1);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_ROCK_2);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_ROCK_3);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_WALL_0);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_WALL_1);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_WALL_2);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_WALL_3);
        BLOCK_DENYLIST.add(PrometheusEngineerBlocks.ENGINEER_WALL_4);
    }
