...
public class WorldGenerator implements IWorldGenerator
{
    ...
    private void generateSurface(World world, Random rand, int chunkX, int chunkZ)
    {
        ...
        Worlds.generateInBiome(world, WORLDGEN_ORE_BAUXITE, rand, 20, 16, 128, chunkCoords, overworldBiomes);
        Worlds.generateInBiome(world, WORLDGEN_ORE_COPPER, rand, 20, 0, 128, chunkCoords, overworldBiomes);
        Worlds.generateInBiome(world, WORLDGEN_ORE_SILICON, rand, 4, 1, 64, chunkCoords, overworldBiomes);
        Worlds.generateInBiome(world, WORLDGEN_ORE_MONAZITE, rand, 4, 1, 48, chunkCoords, overworldBiomes);
        
        if (biome == Biomes.BEACH || biome == Biomes.OCEAN || biome == Biomes.DEEP_OCEAN || biome == Biomes.FROZEN_OCEAN || biome == Biomes.FROZEN_RIVER)
        {
            Worlds.generateInBiome(world, WORLDGEN_ORE_LITHIUM, rand, 1, 1, 48, chunkCoords, overworldBiomes);
        }
        ...
        {
            Worlds.generateInBiome(world, WORLDGEN_ORE_COBALT, rand, 1, 1, 64, chunkCoords, overworldBiomes);
        }
    }
}
