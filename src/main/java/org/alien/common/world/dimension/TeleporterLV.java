...
public class TeleporterLV extends Teleporter
{
    ...
    {
        portal = this.worldServer.provider.getDimension() == PrometheusDimensions.VARDA.getId() ? PrometheusVardaBlocks.PORTAL_VARDA : AlienBlocks.PORTAL_ACHERON;
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int bY = y + j1;
                        int bZ = z + i1 * b1 - l * b0;
                        this.worldServer.setBlockState(new BlockPos(bX, bY, bZ), PrometheusEngineerBlocks.ENGINEER_FLOOR.getDefaultState());
                    }
                }
            }
            ...
            for (y = -1; y <= 1; ++y)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = z + (j3 - 1) * l2 - y * l5;
                        flag = k3 < 0;
                        this.worldServer.setBlockState(new BlockPos(l3, i4, j4), flag ? PrometheusEngineerBlocks.ENGINEER_FLOOR.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
        }
        ...
        for (y = 0; y < 4; ++y)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServer.setBlockState(new BlockPos(l3, i4, j4), (flag ? PrometheusEngineerBlocks.ENGINEER_FLOOR.getDefaultState() : portal.getDefaultState()));
                }
            }
