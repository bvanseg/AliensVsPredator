...
public class ModelAethon extends Model<EntityAethon>
{
    ...
    public final ModelRenderer lWingArm;
    public final ModelRenderer rArm;
    public final ModelRenderer rWingArm;
    public final ModelRenderer stomach;
    public final ModelRenderer neck1;
    public final ModelRenderer lCollar;
    public final ModelRenderer rCollar;
    ...
    public final ModelRenderer neck4;
    public final ModelRenderer head1;
    public final ModelRenderer beakUpper;
    public final ModelRenderer headSlope;
    public final ModelRenderer beakFang1;
    public final ModelRenderer beakFang2;
    public final ModelRenderer beakFang3;
    public final ModelRenderer beakFang4;
    public final ModelRenderer beakLower;
    public final ModelRenderer beakFangLower1;
    public final ModelRenderer beakFangLower2;
    ...
    public final ModelRenderer lToe1;
    public final ModelRenderer lToe2;
    public final ModelRenderer lToe3;
    public final ModelRenderer rShin;
    public final ModelRenderer rshin2;
    public final ModelRenderer rFoot;
    public final ModelRenderer rToe1;
    public final ModelRenderer rToe2;
    public final ModelRenderer rToe3;
    public final ModelRenderer lForearm;
    ...
    public final ModelRenderer lThumb1;
    public final ModelRenderer lThumb2;
    public final ModelRenderer lWingArm2;
    public final ModelRenderer lWingArm3;
    public final ModelRenderer lWingMembrane1;
    public final ModelRenderer lWingArm4;
    public final ModelRenderer lWingMembrane2;
    public final ModelRenderer lWingMembrane3;
    public final ModelRenderer lWingArm5;
    public final ModelRenderer lWingArm6;
    public final ModelRenderer rForearm;
    public final ModelRenderer rHand;
    public final ModelRenderer rFinger1;
    public final ModelRenderer rFinger2;
    public final ModelRenderer rFinger3;
    public final ModelRenderer rFinger4;
    public final ModelRenderer rThumb1;
    public final ModelRenderer rThumb2;
    public final ModelRenderer rWingArm2;
    public final ModelRenderer rWingArm3;
    public final ModelRenderer rWingMembrane1;
    public final ModelRenderer rWingArm4;
    public final ModelRenderer rWingMembrane2;
    public final ModelRenderer rWingMembrane3;
    public final ModelRenderer rWingArm5;
    public final ModelRenderer rWingArm6;
    ...
    public void render(EntityAethon o)
    {
        if (o != null && o instanceof EntityAethon)
        {
            ...
            if (isFlying)
            {
                ...
                this.neck1.rotateAngleX = (float) Math.toRadians((Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));
                this.neck2.rotateAngleX = (float) Math.toRadians((Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));
                this.neck3.rotateAngleX = (float) Math.toRadians((Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));
                this.neck4.rotateAngleX = (float) Math.toRadians((Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));

                this.tail1.rotateAngleX = (float) Math.toRadians(-82F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail2.rotateAngleX = (float) Math.toRadians(-12F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail3.rotateAngleX = (float) Math.toRadians(0F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail4.rotateAngleX = (float) Math.toRadians(0F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail5.rotateAngleX = (float) Math.toRadians(0F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));

                this.lWingArm.rotateAngleY = (float) Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 3F) * wingDistMulti));
                this.lWingArm.rotateAngleZ = (float) Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 2F) * wingDistMulti));
                this.lWingArm.rotateAngleZ = (float) Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 10F) * wingDistMulti));
                this.lWingArm2.rotateAngleX = (float) Math.toRadians((100F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 6F) * wingDistMulti));
                this.lWingArm2.rotateAngleY = (float) -Math.toRadians((30F + (Math.cos((ticks + partialTicks) / (wingSpeed)) * 4F) * wingDistMulti));
                this.lWingArm2.rotateAngleZ = (float) Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 4F) * wingDistMulti));

                this.rWingArm.rotateAngleY = (float) -Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 3F) * wingDistMulti));
                this.rWingArm.rotateAngleZ = (float) -Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 2F) * wingDistMulti));
                this.rWingArm.rotateAngleZ = (float) -Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 10F) * wingDistMulti));
                this.rWingArm2.rotateAngleX = (float) Math.toRadians((100F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 6F) * wingDistMulti));
                this.rWingArm2.rotateAngleY = (float) Math.toRadians((30F + (Math.cos((ticks + partialTicks) / (wingSpeed)) * 4F) * wingDistMulti));
                this.rWingArm2.rotateAngleZ = (float) -Math.toRadians((40F + (Math.sin((ticks + partialTicks) / (wingSpeed)) * 4F) * wingDistMulti));
            }
            else
            {
                ...
                this.neck1.rotateAngleX = (float) Math.toRadians((Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));
                this.neck2.rotateAngleX = (float) Math.toRadians(16F + (Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));
                this.neck3.rotateAngleX = (float) Math.toRadians(16F + (Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));
                this.neck4.rotateAngleX = (float) Math.toRadians(19F + (Math.sin((ticks + partialTicks) / (neckSpeed)) * 3F));

                this.tail1.rotateAngleX = (float) Math.toRadians(-72F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail2.rotateAngleX = (float) Math.toRadians(16F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail3.rotateAngleX = (float) Math.toRadians(16F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail4.rotateAngleX = (float) Math.toRadians(19F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
                this.tail5.rotateAngleX = (float) Math.toRadians(19F + (Math.sin((ticks + partialTicks) / (tailSpeed)) * 3F));
