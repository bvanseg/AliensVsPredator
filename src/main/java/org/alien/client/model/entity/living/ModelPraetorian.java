...
public class ModelPraetorian extends Model<EntityPraetorian>
{
    ...
    {   
        ...
        this.lShin.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F) * 1.4F * swingProgressPrev(obj) - 0.4014257F;
        this.lShin1.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F) * 1.4F * swingProgressPrev(obj) - 0.8028515F;
        ...
        this.rShin.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F + (float) Math.PI) * 1.4F * swingProgressPrev(obj) - 0.4014257F;
        this.rShin1.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F + (float) Math.PI) * 1.4F * swingProgressPrev(obj) - 0.8028515F;
        this.rFoot.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F + (float) Math.PI) * 1.4F * swingProgressPrev(obj);
        this.rArm.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F) * 1.4F * swingProgressPrev(obj) + 0.3665191F;
        this.rClaw.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F) * 1.4F * swingProgressPrev(obj) + 0.3665191F;
        ...
        this.lArm.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F + (float) Math.PI) * 1.4F * swingProgressPrev(obj) + 0.3665191F;
        this.lClaw.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F + (float) Math.PI) * 1.4F * swingProgressPrev(obj) + 0.3665191F;
        ...
        this.headSide1.rotateAngleY = 0.36F + (float) Math.toRadians(headYaw(obj)) * 0.75F;
        this.headSide2.rotateAngleY = -0.36F + (float) Math.toRadians(headYaw(obj)) * 0.75F;
        ...
        this.jaw1.rotateAngleY = (float) Math.toRadians(headYaw(obj)) * 0.75F;
        this.face1.rotateAngleY = (float) Math.toRadians(headYaw(obj)) * 0.75F;
        this.face2.rotateAngleY = (float) Math.toRadians(headYaw(obj)) * 0.75F;
        ...
        newangle = MathHelper.cos(idleProgress(obj) * 3.5F * this.wingspeed) * (float) Math.PI * 0.4F;
